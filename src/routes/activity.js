...
export const getActivityById = async (req, res) => {
    ...
    const activityWithoutAuthorId = {
        ...
        cover_image_filename: activity.cover_image_filename
    };
...
export const newActivity = async (req, res) => {
    ...
    try {
        await req.db.query(query, [title, content, datetime, authorID, "activity", cover_image_filename]);
...
export const editActivity = async (req, res) => {
    ...
    try {
        await req.db.query(query, [title, content, cover_image_filename, activityID, "activity"]);
